...
public class Order {
    ...
    private com.example.desplieguecheapshopbackend.domain.model.User user;
    ...
    public com.example.desplieguecheapshopbackend.domain.model.User getUser() {
        return user;
    }

    public Order setUser(com.example.desplieguecheapshopbackend.domain.model.User user) {
        this.user = user;
        return this;
    }
